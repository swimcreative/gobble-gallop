...
// Project related.
var project                 = 'Gobble Gallop'; // Project Name.
var projectURL              = 'gobble.local'; // Project URL. Could be something like localhost:8888.
...
// Style related.
var styleSRC                = ['./assets/stylesheets/style.scss','./assets/stylesheets/editor-style.scss']; // Path to main .scss file.
 ...
 */
 gulp.task('styles', function () {
    ...
    .pipe( sass( {
      ...
      includePaths:[
                    './bower_components/bourbon/core', //TODO: check how bower looks for bourbon
